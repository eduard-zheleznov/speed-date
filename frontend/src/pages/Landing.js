  ...
  const features = [
    {
      ...
      items: ['Видео звонки в реальном времени', 'Живое общение с реальными людьми', 'Мгновенные совпадения'],
      gradient: 'from-[#FF6B6B] to-[#FF8E8E]'
    },
    {
      icon: Users,
      title: 'Умные фильтры',
      items: ['Выбор возраста и пола', 'Личные предпочтения', 'Фильтр по городу'],
      gradient: 'from-[#4ECDC4] to-[#44A19B]'
    },
    {
      icon: Shield,
      title: 'Безопасность',
      items: ['Проверка возраста 18+', 'Модерация контента', 'Система жалоб'],
